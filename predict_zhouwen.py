...
if __name__ == "__main__":
    args = get_args()
    save_dir = '/home/caidaonan/path_to_dataset/shuiyin/res'
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)
    data_face_pro = '/home/caidaonan/path_to_dataset/shuiyin/shuiyin_test'
    # in_files = args.input
    in_files = [os.path.join(data_face_pro, x) for x in os.listdir(data_face_pro)]
    data_ori = '/home/caidaonan/path_to_dataset/shuiyin/shuiyin_test'
